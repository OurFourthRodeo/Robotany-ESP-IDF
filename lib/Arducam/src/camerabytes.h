...
// Credit to the Arducam library for these definitions
...
// Todo: The sensor_reg arrays were often stored in
// program memory. I could save RAM by moving them there.
